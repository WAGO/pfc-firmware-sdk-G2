...
libutility.a_DISABLEDWARNINGS += packed inline
...
libutility.a_CPPFLAGS += $(call uniq, $(libutility.a_INCLUDES))
libutility.a_CPPFLAGS += 
libutility.a_CPPFLAGS += -isystem ${SYSROOT}/usr/include/libnl3
libutility.a_CPPFLAGS += -isystem ${SYSROOT}/usr/include/glib-2.0
...
utility_tests.elf_DISABLEDWARNINGS += packed inline
...
utility_tests.elf_CLANG_TIDY_RULESET = $(CLANG_TIDY_CHECKS)
utility_tests.elf_CLANG_TIDY_CHECKS += $(GTEST_CLANG_TIDY_CHECKS)
utility_tests.elf_CLANG_TIDY_CHECKS += $(SHARED_CLANG_TIDY_CHECKS)
