...
::std::string UriEscape::Unescape(::std::string&& escaped_uri) const {
  return {Unescape(escaped_uri)};
}
...
::std::string UriEscape::Escape(::std::string&& escaped_uri) const {
  return {Escape(escaped_uri)};
}
