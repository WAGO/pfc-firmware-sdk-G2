...
class INetlinkMonitor {
 public:
  INetlinkMonitor() = default;
  virtual ~INetlinkMonitor() = default;

  INetlinkMonitor(const INetlinkMonitor &other) = delete;
  INetlinkMonitor& operator=(const INetlinkMonitor &other) = delete;
  INetlinkMonitor(INetlinkMonitor &&other) = delete;
  INetlinkMonitor& operator=(INetlinkMonitor &&other) = delete;
