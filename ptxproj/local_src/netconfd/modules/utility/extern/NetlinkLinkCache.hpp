...
class NetlinkLinkCache : public NetlinkCache, public IInterfaceMonitor {
 public:
  ...
  ~NetlinkLinkCache() override;

  NetlinkLinkCache(const NetlinkLinkCache &other) = delete;
  NetlinkLinkCache& operator=(const NetlinkLinkCache &other) = delete;
  NetlinkLinkCache(NetlinkLinkCache &&other) = delete;
  NetlinkLinkCache& operator=(NetlinkLinkCache &&other) = delete;
