...
class BackupRestoreFake : public IBackupRestore {
 public:
  ...
  Status Backup(const ::std::string& file_path, const ::std::string& network_data, const ::std::string& dipswitch_data, uint32_t version) const override{
    (void) file_path;
  ...
  Status Restore(const ::std::string& file_path, ::std::string& network_data, ::std::string& dipswitch_data, uint32_t& version) const override{
    (void) file_path;
