...
void PrioritizedHostAndDomainname::Add(const Interface &interface, const ::std::string &hostname,
                                       const ::std::string &domain) {
  dynamic_host_domain_map_.insert_or_assign(interface, ::std::pair { hostname, domain });

}

void PrioritizedHostAndDomainname::Remove(const Interface &interface) {
...
::std::string PrioritizedHostAndDomainname::GetHostname(const Interface &interface) {
  if (dynamic_host_domain_map_.find(interface) != dynamic_host_domain_map_.end()) {
