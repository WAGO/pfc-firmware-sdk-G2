...
netconfd.elf_INCLUDES += $(call uniq,$(libnetconfd.a_INCLUDES) $(libnetconfddbus.a_INCLUDES))
netconfd.elf_DEFINES += -DBOOST_LOG_DYN_LINK -DNETCONFD_VERSION=$(netconfd.elf_VERSION)
...
netconfd_tests.elf_CLANG_TIDY_RULESET = $(CLANG_TIDY_CHECKS)
netconfd_tests.elf_CLANG_TIDY_CHECKS += $(GTEST_CLANG_TIDY_CHECKS)
