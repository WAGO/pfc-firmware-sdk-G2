...
class BridgeConfig {
 public:
   ...
   *
   */
  explicit BridgeConfig(const netconf::BridgeConfig& config);

  BridgeConfig(const BridgeConfig &other) = default;
  BridgeConfig(BridgeConfig &&other) = delete;
  BridgeConfig& operator=(const BridgeConfig &other) = default;
  BridgeConfig& operator=(BridgeConfig &&other) = default;
   ...
   */
  void AssignInterfaceToBridge(const ::std::string &interface, const ::std::string &bridge_name, bool remove_bridge_if_empty = false);
   ...
   */
  void DeleteInterface(const ::std::string &interface);
   ...
   */
  ::std::vector<::std::string> GetBridgeInterfaces(const ::std::string &bridge_name) const;
   ...
   */
  ::std::string GetBridgeOfInterface(const ::std::string &interface) const;
   ...
   */
  bool AreInSameBridge(const ::std::vector<::std::string> &ports_interfaces) const;
