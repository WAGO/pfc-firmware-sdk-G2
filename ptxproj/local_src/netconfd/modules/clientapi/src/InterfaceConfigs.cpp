...
void InterfaceConfigs::RemoveInterfaceConfig(const ::std::string &interface) {
  RemoveConfig(interface);
}

InterfaceConfig& InterfaceConfigs::operator[](const ::std::string &interface) {
  auto matches_interface_name = [&](const InterfaceConfig &c) {
  ...
  return configs_.emplace_back(netconf::Interface::CreatePort(interface));
}

::std::optional<InterfaceConfig> InterfaceConfigs::GetInterfaceConfig(const ::std::string &interface) {
...
static ::std::string InterfaceConfigToString(const netconf::InterfaceConfig &config, const ::std::string &sep) {
  ...
  values.push_back("device=" + config.interface_.GetLabel());
