...
template<>
JsonBuilder& JsonBuilder::Append<Interfaces>(const string& key, const Interfaces& interfaces, [[maybe_unused]] const FirmwareVersion& target_version) {
  json_[key] = InterfacesToNJson(interfaces);
  return *this;
}
