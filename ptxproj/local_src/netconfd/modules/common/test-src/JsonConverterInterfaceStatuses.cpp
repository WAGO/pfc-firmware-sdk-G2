...
class JsonConverterInterfaceStatusesTest : public testing::Test {
 public:
  ...
  InterfaceStatuses statuses_ {
    InterfaceStatus{ Interface::CreatePort("X1"), InterfaceState::UP, Autonegotiation::ON, 100, Duplex::FULL, LinkState::UP, MacAddress::FromString("00:30:DE:01:02:03") },
    InterfaceStatus{ Interface::CreatePort("X2"), InterfaceState::UP, Autonegotiation::OFF, 100, Duplex::HALF, LinkState::UP, MacAddress::FromString("00:30:DE:01:02:04") },
    InterfaceStatus{ Interface::CreatePort("X3"), InterfaceState::DOWN, Autonegotiation::OFF, 10, Duplex::HALF, LinkState::DOWN, MacAddress::FromString("00:30:DE:01:02:05") }
  };
