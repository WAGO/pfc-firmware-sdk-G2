...
struct _netconfdIp_configIface
{
  ...
  gboolean (*handle_gettempdhcpclientid) (
    netconfdIp_config *object,
    GDBusMethodInvocation *invocation);
...
void netconfd_ip_config_complete_gettempdhcpclientid (
    netconfdIp_config *object,
    GDBusMethodInvocation *invocation,
    const gchar *config,
    const gchar *result);
...
void netconfd_ip_config_call_gettempdhcpclientid (
    netconfdIp_config *proxy,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
    gpointer user_data);

gboolean netconfd_ip_config_call_gettempdhcpclientid_finish (
    netconfdIp_config *proxy,
    gchar **out_config,
    gchar **out_result,
    GAsyncResult *res,
...
gboolean netconfd_ip_config_call_gettempdhcpclientid_sync (
    netconfdIp_config *proxy,
    gchar **out_config,
    gchar **out_result,
    GCancellable *cancellable,
...
/* ------------------------------------------------------------------------ */
/* Declarations for de.wago.netconfd1.interface */

#define NETCONFD_TYPE_INTERFACE (netconfd_interface_get_type ())
#define NETCONFD_INTERFACE(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), NETCONFD_TYPE_INTERFACE, netconfdInterface))
#define NETCONFD_IS_INTERFACE(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), NETCONFD_TYPE_INTERFACE))
#define NETCONFD_INTERFACE_GET_IFACE(o) (G_TYPE_INSTANCE_GET_INTERFACE ((o), NETCONFD_TYPE_INTERFACE, netconfdInterfaceIface))

struct _netconfdInterface;
typedef struct _netconfdInterface netconfdInterface;
typedef struct _netconfdInterfaceIface netconfdInterfaceIface;

struct _netconfdInterfaceIface
{
  GTypeInterface parent_iface;
...
GType netconfd_interface_get_type (void) G_GNUC_CONST;

GDBusInterfaceInfo *netconfd_interface_interface_info (void);
guint netconfd_interface_override_properties (GObjectClass *klass, guint property_id_begin);


/* D-Bus method call completion functions: */
void netconfd_interface_complete_add (
    netconfdInterface *object,
    GDBusMethodInvocation *invocation,
    const gchar *result);

void netconfd_interface_complete_delete (
    netconfdInterface *object,
    GDBusMethodInvocation *invocation,
    const gchar *result);
...
/* D-Bus method calls: */
void netconfd_interface_call_add (
...
gboolean netconfd_interface_call_add_finish (
    netconfdInterface *proxy,
    gchar **out_result,
    GAsyncResult *res,
    GError **error);

gboolean netconfd_interface_call_add_sync (
    netconfdInterface *proxy,
    const gchar *arg_parameters,
    gchar **out_result,
    GCancellable *cancellable,
...
void netconfd_interface_call_delete (
    netconfdInterface *proxy,
    const gchar *arg_name,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean netconfd_interface_call_delete_finish (
    netconfdInterface *proxy,
    gchar **out_result,
    GAsyncResult *res,
    GError **error);

gboolean netconfd_interface_call_delete_sync (
    netconfdInterface *proxy,
    const gchar *arg_name,
    gchar **out_result,
    GCancellable *cancellable,
...
#define NETCONFD_TYPE_INTERFACE_PROXY (netconfd_interface_proxy_get_type ())
#define NETCONFD_INTERFACE_PROXY(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), NETCONFD_TYPE_INTERFACE_PROXY, netconfdInterfaceProxy))
#define NETCONFD_INTERFACE_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), NETCONFD_TYPE_INTERFACE_PROXY, netconfdInterfaceProxyClass))
#define NETCONFD_INTERFACE_PROXY_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), NETCONFD_TYPE_INTERFACE_PROXY, netconfdInterfaceProxyClass))
#define NETCONFD_IS_INTERFACE_PROXY(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), NETCONFD_TYPE_INTERFACE_PROXY))
#define NETCONFD_IS_INTERFACE_PROXY_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), NETCONFD_TYPE_INTERFACE_PROXY))

typedef struct _netconfdInterfaceProxy netconfdInterfaceProxy;
typedef struct _netconfdInterfaceProxyClass netconfdInterfaceProxyClass;
typedef struct _netconfdInterfaceProxyPrivate netconfdInterfaceProxyPrivate;

struct _netconfdInterfaceProxy
{
  /*< private >*/
  GDBusProxy parent_instance;
  netconfdInterfaceProxyPrivate *priv;
};

struct _netconfdInterfaceProxyClass
{
  GDBusProxyClass parent_class;
};

GType netconfd_interface_proxy_get_type (void) G_GNUC_CONST;

#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (netconfdInterfaceProxy, g_object_unref)
#endif

void netconfd_interface_proxy_new (
    GDBusConnection     *connection,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
    ...
    GAsyncReadyCallback  callback,
    gpointer             user_data);
netconfdInterface *netconfd_interface_proxy_new_finish (
    GAsyncResult        *res,
    GError             **error);
netconfdInterface *netconfd_interface_proxy_new_sync (
    GDBusConnection     *connection,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
...
void netconfd_interface_proxy_new_for_bus (
    GBusType             bus_type,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
    ...
    GAsyncReadyCallback  callback,
    gpointer             user_data);
netconfdInterface *netconfd_interface_proxy_new_for_bus_finish (
    GAsyncResult        *res,
    GError             **error);
netconfdInterface *netconfd_interface_proxy_new_for_bus_sync (
    GBusType             bus_type,
    GDBusProxyFlags      flags,
    const gchar         *name,
    const gchar         *object_path,
...
#define NETCONFD_TYPE_INTERFACE_SKELETON (netconfd_interface_skeleton_get_type ())
#define NETCONFD_INTERFACE_SKELETON(o) (G_TYPE_CHECK_INSTANCE_CAST ((o), NETCONFD_TYPE_INTERFACE_SKELETON, netconfdInterfaceSkeleton))
#define NETCONFD_INTERFACE_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_CAST ((k), NETCONFD_TYPE_INTERFACE_SKELETON, netconfdInterfaceSkeletonClass))
#define NETCONFD_INTERFACE_SKELETON_GET_CLASS(o) (G_TYPE_INSTANCE_GET_CLASS ((o), NETCONFD_TYPE_INTERFACE_SKELETON, netconfdInterfaceSkeletonClass))
#define NETCONFD_IS_INTERFACE_SKELETON(o) (G_TYPE_CHECK_INSTANCE_TYPE ((o), NETCONFD_TYPE_INTERFACE_SKELETON))
#define NETCONFD_IS_INTERFACE_SKELETON_CLASS(k) (G_TYPE_CHECK_CLASS_TYPE ((k), NETCONFD_TYPE_INTERFACE_SKELETON))

typedef struct _netconfdInterfaceSkeleton netconfdInterfaceSkeleton;
typedef struct _netconfdInterfaceSkeletonClass netconfdInterfaceSkeletonClass;
typedef struct _netconfdInterfaceSkeletonPrivate netconfdInterfaceSkeletonPrivate;

struct _netconfdInterfaceSkeleton
{
  /*< private >*/
  GDBusInterfaceSkeleton parent_instance;
  netconfdInterfaceSkeletonPrivate *priv;
};

struct _netconfdInterfaceSkeletonClass
{
  GDBusInterfaceSkeletonClass parent_class;
};

GType netconfd_interface_skeleton_get_type (void) G_GNUC_CONST;

#if GLIB_CHECK_VERSION(2, 44, 0)
G_DEFINE_AUTOPTR_CLEANUP_FUNC (netconfdInterfaceSkeleton, g_object_unref)
#endif

netconfdInterface *netconfd_interface_skeleton_new (void);
