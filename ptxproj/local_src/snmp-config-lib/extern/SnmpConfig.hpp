...
enum class AuthenticationType : uint16_t {
  None   = 0,
  MD5    = 1,
  SHA    = 2,
  SHA224 = 3,
...
class User {
 public:
  ...
  User(::std::string name, Access access, SecurityLevel security_level, AuthenticationType authentication_type,
...
class TrapReceiverV3 {
 public:
  ...
  TrapReceiverV3(::std::string name, SecurityLevel security_level, AuthenticationType authentication_type,
                 ::std::string authentication_key, Privacy privacy, ::std::string privacy_key, ::std::string host);
