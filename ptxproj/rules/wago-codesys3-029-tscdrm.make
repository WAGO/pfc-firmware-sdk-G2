...
CDS3_TSCDRM_PACKAGE_DIR := $(PTXDIST_TEMPDIR)/package/$(CDS3_TSCDRM_PACKAGE_NAME)
...
ifdef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	mkdir -p $(CDS3_TSCDRM_PACKAGE_DIR)
	cd $(CDS3_TSCDRM_PACKAGE_DIR) && \
	ar -xov $(CDS3_TSCDRM_PLATFORMCONFIGPACKAGEDIR)/$(CDS3_TSCDRM_PACKAGE_NAME).ipk
	@$(call install_archive, cds3-tscdrm, 0, 0, $(CDS3_TSCDRM_PACKAGE_DIR)/data.tar.gz, )
else
	# WAGO_TOOLS_BUILD_VERSION_TRUNK | WAGO_TOOLS_BUILD_VERSION_RELEASE
