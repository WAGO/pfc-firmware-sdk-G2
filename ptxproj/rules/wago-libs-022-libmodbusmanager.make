...
LIBMODBUSMANAGER_PACKAGE_DIR := $(PTXDIST_TEMPDIR)/package/$(LIBMODBUSMANAGER_PACKAGE_NAME)
...
ifdef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES 
	...
	mkdir -p $(LIBMODBUSMANAGER_PACKAGE_DIR)
	cd $(LIBMODBUSMANAGER_PACKAGE_DIR) && \
	ar -xov $(LIBMODBUSMANAGER_PLATFORMCONFIGPACKAGEDIR)/$(LIBMODBUSMANAGER_PACKAGE_NAME).ipk  
	@$(call install_archive, libmodbusmanager, 0, 0, $(LIBMODBUSMANAGER_PACKAGE_DIR)/data.tar.gz, /)
else
	# WAGO_TOOLS_BUILD_VERSION_TRUNK | WAGO_TOOLS_BUILD_VERSION_RELEASE	
