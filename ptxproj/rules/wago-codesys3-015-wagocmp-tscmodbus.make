...
CDS3_TSCMODBUS_URL        := file://wago_intern/codesys3-Component/$(CDS3_TSCMODBUS)
CDS3_TSCMODBUS_SRC_DIR    := $(call ptx/in-path, PTXDIST_PATH, wago_intern/codesys3-Component/$(CDS3_TSCMODBUS))
...
CDS3_TSCMODBUS_PACKAGE_DIR := $(PTXDIST_TEMPDIR)/package/$(CDS3_TSCMODBUS_PACKAGE_NAME)
...
ifdef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	mkdir -p $(CDS3_TSCMODBUS_PACKAGE_DIR)
	cd $(CDS3_TSCMODBUS_PACKAGE_DIR) && \
	ar -xov $(CDS3_TSCMODBUS_PLATFORMCONFIGPACKAGEDIR)/$(CDS3_TSCMODBUS_PACKAGE_NAME).ipk
	@$(call install_archive, cds3-tscmodbus, 0, 0, $(CDS3_TSCMODBUS_PACKAGE_DIR)/data.tar.gz, )
else
	# WAGO_TOOLS_BUILD_VERSION_TRUNK | WAGO_TOOLS_BUILD_VERSION_RELEASE
