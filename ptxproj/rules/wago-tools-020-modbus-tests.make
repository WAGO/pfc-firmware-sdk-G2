...
ifndef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	@mv $(MODBUS_TESTS_SRC_DIR)/$(MODBUS_TESTS_RTU_CLIENT) $(MODBUS_TESTS_PKGDIR)/usr/bin/
	@mv $(MODBUS_TESTS_SRC_DIR)/$(MODBUS_TESTS_RTU_SERVER) $(MODBUS_TESTS_PKGDIR)/usr/bin/
