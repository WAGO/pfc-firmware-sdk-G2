...
LIBEXTMEMCPY_XSOURCE		:= $(call ptx/in-path, PTXDIST_PATH, local_src/$(LIBEXTMEMCPY_NAME)-$(LIBEXTMEMCPY_VERSION))
ifeq ($(LIBEXTMEMCPY_XSOURCE),)
LIBEXTMEMCPY_XSOURCE	:= $(PTXDIST_WORKSPACE)/local_src/$(LIBEXTMEMCPY_NAME)-$(LIBEXTMEMCPY_VERSION)
endif
...
$(STATEDIR)/libextmemcpy.get:
	...
	@rsync -a --exclude=output/ $(LIBEXTMEMCPY_XSOURCE) $(BUILDDIR)
	@$(call touch)
