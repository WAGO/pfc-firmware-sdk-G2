...
#       #
#       # busybox init: pam_faillock folder for tally files
#       #
ifdef PTXCONF_INITMETHOD_BBINIT
ifdef PTXCONF_PAM_PAM_FAILLOCK
	@$(call install_alternative, pam, 0, 0, 0755, /etc/init.d/faillock)

ifneq ($(call remove_quotes, $(PTXCONF_PAM_FAILLOCK_BBINIT_LINK)),)
	@$(call install_link, pam, \
		/etc/init.d/faillock, \
		/etc/rc.d/$(PTXCONF_PAM_FAILLOCK_BBINIT_LINK))
endif
endif # PTXCONF_PAM_PAM_FAILLOCK
