...
LOGROTATE_MD5		:= 4dc63166a40087b2052051c707f791dd
LOGROTATE		:= logrotate-$(LOGROTATE_VERSION)
LOGROTATE_ARCHIVE_NAME  := logrotate-$(LOGROTATE_VERSION)
LOGROTATE_SUFFIX	:= tar.gz
LOGROTATE_URL		:= https://github.com/logrotate/logrotate/releases/download/$(LOGROTATE_VERSION)/$(LOGROTATE_ARCHIVE_NAME).$(LOGROTATE_SUFFIX)
