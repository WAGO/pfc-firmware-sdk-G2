...
CDS3_TSCSYSEXT_PACKAGE_DIR := $(PTXDIST_TEMPDIR)/package/$(CDS3_TSCSYSEXT_PACKAGE_NAME)
...
$(STATEDIR)/cds3-tscsysext.prepare:
	@$(call targetinfo)
ifndef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	$(MAKE) -C $(CDS3_TSCSYSEXT_DIR) SYSROOT=$(PTXCONF_SYSROOT_TARGET) itf
	$(MAKE) -C $(CDS3_TSCSYSEXT_DIR) SYSROOT=$(PTXCONF_SYSROOT_TARGET) dep
endif
	@$(call touch)
...
CDS3_TSCSYSEXT_MAKE_ENV  := $(CROSS_ENV) ARCH=$(PTXCONF_ARCH_STRING)
...
ifndef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	@cp $(CDS3_TSCSYSEXT_DIR)/*Itf.h $(PTXCONF_SYSROOT_TARGET)/usr/include/codesys3/
...
ifdef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	mkdir -p $(CDS3_TSCSYSEXT_PACKAGE_DIR)
	cd $(CDS3_TSCSYSEXT_PACKAGE_DIR) && \
	ar -xov $(CDS3_TSCSYSEXT_PLATFORMCONFIGPACKAGEDIR)/$(CDS3_TSCSYSEXT_PACKAGE_NAME).ipk
	@$(call install_archive, cds3-tscsysext, 0, 0, $(CDS3_TSCSYSEXT_PACKAGE_DIR)/data.tar.gz, )
else
	# WAGO_TOOLS_BUILD_VERSION_TRUNK | WAGO_TOOLS_BUILD_VERSION_RELEASE
