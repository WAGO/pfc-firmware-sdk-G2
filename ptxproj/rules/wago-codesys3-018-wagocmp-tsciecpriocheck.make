...
CDS3_TSCIECPRIOCHECK_PACKAGE_DIR := $(PTXDIST_TEMPDIR)/package/$(CDS3_TSCIECPRIOCHECK_PACKAGE_NAME)
...
$(STATEDIR)/cds3-tsciecpriocheck.prepare:
	@$(call targetinfo)
ifndef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	$(MAKE) -C $(CDS3_TSCIECPRIOCHECK_DIR) SYSROOT=$(PTXCONF_SYSROOT_TARGET) dep
endif
	@$(call touch)
...
ifdef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	mkdir -p $(CDS3_TSCIECPRIOCHECK_PACKAGE_DIR)
	cd $(CDS3_TSCIECPRIOCHECK_PACKAGE_DIR) && \
	ar -xov $(CDS3_TSCIECPRIOCHECK_PLATFORMCONFIGPACKAGEDIR)/$(CDS3_TSCIECPRIOCHECK_PACKAGE_NAME).ipk
	@$(call install_archive, cds3-tsciecpriocheck, 0, 0, $(CDS3_TSCIECPRIOCHECK_PACKAGE_DIR)/data.tar.gz, )
else
