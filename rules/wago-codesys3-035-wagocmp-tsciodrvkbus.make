## -*-makefile-*-
# $Id: wago-codesys3-035-wagocmp-tsciodrvkbus.make 68886 2022-07-14 12:31:38Z karsten.nuenthel@wago.com $
#
...
ifdef PTXCONF_WAGO_TOOLS_BUILD_VERSION_BINARIES
	...
	rm -rf $(CDS3_TSCIODRVKBUS_PLATFORMCONFIGPACKAGEDIR)/tmp/*
	cd $(CDS3_TSCIODRVKBUS_PLATFORMCONFIGPACKAGEDIR)/tmp && \
	ar -xov $(CDS3_TSCIODRVKBUS_PLATFORMCONFIGPACKAGEDIR)/$(CDS3_TSCIODRVKBUS_PACKAGE_NAME).ipk
	@$(call install_archive, cds3-tsciodrvkbus, 0, 0, $(CDS3_TSCIODRVKBUS_PLATFORMCONFIGPACKAGEDIR)/tmp/data.tar.gz, )
else
	# WAGO_TOOLS_BUILD_VERSION_TRUNK | WAGO_TOOLS_BUILD_VERSION_RELEASE
