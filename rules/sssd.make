...
#	# /usr/lib/sssd/*
#	#
	@$(call install_copy, sssd, 0, 0, 0644, $(SSSD_DIR)/.libs/libsss_ldap.so, /usr/lib/sssd/libsss_ldap.so)
	@$(call install_copy, sssd, 0, 0, 0644, $(SSSD_DIR)/.libs/libsss_files.so, /usr/lib/sssd/libsss_files.so)
	@$(call install_copy, sssd, 0, 0, 0644, $(SSSD_DIR)/.libs/libsss_proxy.so, /usr/lib/sssd/libsss_proxy.so)
	@$(call install_copy, sssd, 0, 0, 0644, $(SSSD_DIR)/.libs/libsss_krb5.so, /usr/lib/sssd/libsss_krb5.so)
